...
KCMUtils.SimpleKCM {
    ...
    Kirigami.FormLayout {
        ...
        QQC2.Label {
            text: i18n("<a href=\"[https://doc.qt.io/qt-6/qml-qtqml-qt.html#formatDateTime-method](https://doc.qt.io/qt-6/qml-qtqml-qt.html#formatDateTime-method)\">Time Format Documentation</a>")
            enabled: showDate.checked
            visible: cfg_dateFormat === "custom"
            wrapMode: Text.Wrap
